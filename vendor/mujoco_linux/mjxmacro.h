...
/*
    This file is not needed in regular user projects and is not included in mujoco.h.
    It is only needed when writing MuJoCo wrappers for other environments, such as MATLAB,
    where one has to create data structures with the same fields as mjModel and mjData.
*/
