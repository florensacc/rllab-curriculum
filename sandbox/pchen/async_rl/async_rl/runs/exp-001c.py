"""
Try more capable image counter in A3C + Freeway
"""
...
vg = VariantGenerator()
vg.add("game",["freeway"])
vg.add("dim_key",[128,256,512])
vg.add("use_current_image",[False,True])
...
for v in vg.variants():
    ...
    use_current_image = v["use_current_image"]
    dim_key = v["dim_key"]
    ...
    _hash = SimHash(
        item_dim=preprocessor.output_dim,
        dim_key=dim_key,
        bucket_sizes=None,
    )
