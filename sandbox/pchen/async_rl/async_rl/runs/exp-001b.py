"""
Try small entropy bonus in A3C + Freeway
"""
...
agent_types = ["a3c"]
bonus_coeffs = [0.05]
entropy_bonuses = [0.01, 0.001, 0.0001]
dim_key = 64
target_update_frequency = 40000
locked_stats = True

for bonus_count_target in ["ram"]:
    ...
    for idx,game,agent_type,bonus_coeff,entropy_bonus in \
        itertools.product(range(repetitions),games,agent_types,bonus_coeffs,entropy_bonuses):
        # The meat ---------------------------------------------
        env = AtariEnv(
