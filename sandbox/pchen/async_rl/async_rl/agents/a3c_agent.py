...
from sandbox.pchen.async_rl.async_rl.utils.nonbias_weight_decay import NonbiasWeightDecay
from sandbox.pchen.async_rl.async_rl.networks import dqn_head, v_function
from sandbox.pchen.async_rl.async_rl.policies import policy
...
class A3CFF(chainer.ChainList, A3CModel):
    ...
    def __init__(self, n_actions):
        self.head = dqn_head.NIPSDQNHead() # observation -> feature
...
class A3CAgent(Agent,Shareable,Picklable):
    ...
    def __init__(self,
        ...
        if model_type == "ff":
            self.shared_model = A3CFF(n_actions)
