...
# from sandbox.pchen.async_rl.async_rl.agents.dqn_agent import Bellman
...
#         return self.head_to_q(self.head(state))
#
# class BoltzmannDQNAgent(Agent,Shareable,Picklable):
#     """
...
#         new_agent = BoltzmannDQNAgent(**self.init_params)
...
#
#             for k,vs in self.misc_stats.items():
