...
def continuous_mix_logistic_loss(x,l,sum_all=True):
    """ log-likelihood for mixture of (continuous) logistics, assumes the data has been rescaled to [-1,1] interval """
    ...
    log_probs = mid_in - log_scales - 2.*tf.nn.softplus(mid_in) - np.log(127.5) # this is now a variational lower bound
