...
for v in variants[:1]:
    ...
    # with skip_if_exception():
        ...
        algo = VAE(
            ...
            resume_from="/home/peter/rllab-private/data/local/play-0918-hybrid-cc-cifar-ml-3ldc-resnet-arch/play_0918_hybrid_cc_cifar_ml_3ldc_resnet_arch_2016_09_18_20_13_40_0001",
        )

        run_experiment_lite(
            algo.train(),
            exp_prefix="play_0918_hybrid_cc_cifar_ml_3ldc_resnet_arch_vis",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
