...
from sandbox.pchen.InfoGAN.infogan.misc.datasets import MnistDataset, FaceDataset, BinarizedMnistDataset, \
    ResamplingBinarizedMnistDataset, ResamplingBinarizedOmniglotDataset, Cifar10Dataset, load_svhn, SvhnDataset
...
for v in variants[:1]:
    ...
    # with skip_if_exception():
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="play_0918_hybrid_cc_SVHN_ml_3ldc_resnet_arch",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
