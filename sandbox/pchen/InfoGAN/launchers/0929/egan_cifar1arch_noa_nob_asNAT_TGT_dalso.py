...
# adaptive step size natural gradient
# also uses natural step for discriminator
if __name__ == "__main__":
    ...
    # anneal_nobn_bsr_0.8_cifar1_nobn_dls_bs_64_30ensemble_cifar10_2016_09_26_23_49_19
    # is stable but possibly converge too fast? no-anneal still diverges
    arch = "cifar1_nobn"
    nr_model = 30
    bsr = 0.8
    asnat = 0.1
    update_freq = 5
    exp_name = "diffP_one_sided_freq_%s_3sClip_asNAT%s_nobn_bsr_%s_%s_dls_bs_%s_%sensemble_cifar10_%s" % (
        update_freq,
        asnat,
        bsr,
        arch,
    ...
    # exp_name = "diffP_one_side_tester_dalso%s"%timestamp
    ...
    algo = EnsembleGANTrainer(
        ...
        natural_step=asnat,
        second_order_natural_approx=True,
        natural_g_only=False,
        tgt_network=True,
        tgt_network_update_freq=update_freq,
        natural_d_one_sided=True,
    )
