...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = VAE(
            ...
            img_on=False,
            vis_ar=False,
            resume_from="data/local/1103-vlae-final-run-initial/1103_vlae_final_run_initial_2016_11_03_01_15_02_0001/pa_mnist_ar_chns_16__93600.ckpt"
        )
        ...
        run_experiment_lite(
            algo.eval(),
            exp_prefix="1103_vlae_final_run_initial",
            seed=v["seed"],
            variant=v,
            # mode=mode,
            use_gpu=True,
