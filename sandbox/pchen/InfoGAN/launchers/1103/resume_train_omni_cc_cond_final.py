...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = VAE(
            ...
            img_on=False,
            vis_ar=False,
            resume_from="data/local/1102-vlae-final-run-initial/1102_vlae_final_run_initial_2016_11_02_10_43_57_0001",
        )
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="1103_resume_artie_vlae_final_run_initial",
            seed=v["seed"],
            variant=v,
            # mode=mode,
            use_gpu=True,
