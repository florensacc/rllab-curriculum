...
for v in variants[:1]:
    ...
    # with skip_if_exception():
        ...
        dataset = Cifar10Dataset(scramble_vai=True)
        ...
        algo = VAE(
            ...
            min_kl=v["min_kl"],
            k=1,
            vali_eval_interval=vali_int,
            exp_avg=None,#v["exp_avg"],
            anneal_after=v["anneal_after"],
            img_on=False,
            summary_interval=(50000//128*20)//vali_int * vali_int,
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="play_0918_hybrid_cc_cifar_ml_3ldc_resnet_sanity2_big_scrambled",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
