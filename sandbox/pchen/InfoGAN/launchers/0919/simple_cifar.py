...
from sandbox.pchen.InfoGAN.infogan.misc.datasets import MnistDataset, FaceDataset, BinarizedMnistDataset, \
    ResamplingBinarizedMnistDataset, Cifar10Dataset
import numpy as np
import tensorflow as tf
import time

from sandbox.pchen.InfoGAN.infogan.misc.distributions import ConvAR, MeanBernoulli, Mixture, DiscretizedLogistic
...
_ = ar_conv_dist.logli(
    init_x.reshape([128, 32, 32, 3]).astype(np.float32),
    {}
)
