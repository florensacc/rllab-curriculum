# overfitting like crazy on data/local/0927-pool-encoder-arch-on-overfit/
# it can get to 3.11 on train so it seems expressive
...
class VG(VariantGenerator):
    ...
    def network(self):
        ...
        yield "resv1_k3_pixel_bias_filters_ratio_32_global_pool_simple_dec"
...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="0928_simple_decoder_arch_on_overfit",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
