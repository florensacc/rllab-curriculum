...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = VAE(
            ...
            resume_from="/home/peter/rllab-private/data/local/1003-init-convaf-on-spatial-code/1003_init_convaf_on_spatial_code_2016_10_03_22_20_16_0001",
        )

        run_experiment_lite(
            algo.train(),
            exp_prefix="1006_resume_convaf_on_spatial_code",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
