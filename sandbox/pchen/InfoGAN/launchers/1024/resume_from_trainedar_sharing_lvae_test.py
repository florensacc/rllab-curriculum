...
# this tries to resume from above model
...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = ShareVAE(
            ...
            vis_ar=False,
            slow_kl=True,
            resume_from="data/local/1018-nokl-staged-FIXKL-share-lvae-play/1018_nokl_staged_FIXKL_share_lvae_play_2016_10_18_12_10_17_0001/",
            resume_includes=["infer", "cond"],
            # staged=True,
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="1024_resume_from_trained_ar_share_lvae_play",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
