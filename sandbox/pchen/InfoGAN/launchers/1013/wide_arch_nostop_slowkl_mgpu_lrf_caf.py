...
# no-stop from anneal & experiment with bigger or deeper convaf

# wider arch & try tying or not
...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="1013_widear_nostop_deepaf_slowkl_mgpu_lrf_convaf_spatial_code",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
