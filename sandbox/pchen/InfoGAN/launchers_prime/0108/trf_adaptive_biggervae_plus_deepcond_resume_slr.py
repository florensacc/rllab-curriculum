...
# deep cond
# resume from 300 bits to 100 bits
...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = ShareVAE(
            ...
            ema_kl_decay=0.95,
            deep_cond=True,
            resume_from="/home/peter/rllab-private/data/local/0107-TRF-adaptive-anneal-deepcond-debug2/0107_TRF_adaptive_anneal_deepcond_debug2_2017_01_07_17_42_35_0001/bak/pa_mnist_ar_nr_cond__160000.ckpt",
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="0108_TRF_adaptive_anneal_deepcond_debug2_resume_slr",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
