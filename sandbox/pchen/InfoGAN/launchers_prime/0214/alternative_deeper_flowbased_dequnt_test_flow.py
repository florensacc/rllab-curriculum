...
# increase blocks, and increase flows are observation level
...
def run_task(v):
    ...
    with scopes.arg_scope([resnet_blocks_gen], filters=filters, blocks=5):
        cur = shaped_noise
...
for v in variants[i:i+1]:
    run_experiment_lite(
        ...
        exp_prefix="0214_alternative_deeper_flow_based_dequant",
        variant=v,
