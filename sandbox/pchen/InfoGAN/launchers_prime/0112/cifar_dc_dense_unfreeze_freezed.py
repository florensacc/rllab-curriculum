...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = ShareVAE(
            ...
            resume_from="/home/peter/rllab-private/data/local/0111-cifar-dc-highgen-dense-scaled-resumed-encfreezed/0111_cifar_dc_highgen_dense_scaled_resumed_encfreezed_2017_01_11_13_03_36_0001/299/pa_mnist_ar_nr_cond__160000.ckpt",
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="0112_cifar_dc_dense_unfreeze_freezed",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
