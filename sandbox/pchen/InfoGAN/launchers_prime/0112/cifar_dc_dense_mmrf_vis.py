...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = ShareVAE(
            ...
            resume_from="/home/peter/rllab-private/data/local/0111-cifar-dc-dense-mmrf/0111_cifar_dc_dense_mmrf_2017_01_12_00_41_37_0001/pa_mnist_ar_nr_cond__90000.ckpt"
        ...
        run_experiment_lite(
            algo.vis(),
            exp_prefix="0112_cifar_dc_dense_mmrf_vis",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
