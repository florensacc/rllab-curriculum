...
for v in variants[i:i+1]:
    ...
    # with skip_if_exception():
        ...
        algo = ShareVAE(
            ...
            resume_from="/home/peter/rllab-private/data/local/0111-cifar-dc-dense-mrf/0111_cifar_dc_dense_mrf_2017_01_12_00_00_12_0001/pa_mnist_ar_nr_cond__150000.ckpt",
        ...
        run_experiment_lite(
            algo.train(),
            exp_prefix="0112_cifar_dc_dense_mrf_resume_0.03_tol",
            seed=v["seed"],
            variant=v,
            mode="local",
            # mode="lab_kube",
