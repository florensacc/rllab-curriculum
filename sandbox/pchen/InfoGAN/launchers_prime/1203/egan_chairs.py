...
import os
from sandbox.pchen.InfoGAN.infogan.misc.datasets import MnistDataset, Cifar10Dataset, ChairDataset
...
if __name__ == "__main__":
    ...
    root_log_dir = "logs/chairs"
    root_checkpoint_dir = "ckt/chairs"
    batch_size = 64
    ...
    arch = "chairs_tmp_nobn"
    nr_model = 30
    bsr = 0.8
    exp_name = "SLOWanneal_nobn_bsr_%s_%s_dls_bs_%s_%sensemble_cifar10_%s" % (
        bsr,
        arch,
        batch_size,
        nr_model,
