"""
This is the PREVIOUSLY used setup.  Not optimized.
"""
...
class AtariEnv(Env, Serializable):
    ...
    def observation_space(self):
        ...
        if self._obs_type == "ram":
            return spaces.Box(low=-1, high=1, shape=(128,))
        elif self._obs_type == "image":
            return spaces.Box(low=-1, high=1, shape=(HEIGHT, WIDTH))

    def _get_obs(self):
        if self._obs_type == "ram":
            return self._get_obs_ram()
        elif self._obs_type == "image":
