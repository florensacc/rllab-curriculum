"""
Will run the GPU-based, parallel sampling version of TRPO.
Also will run pre-allocating version of mujoco_py.
Humanoid -- for now, skips the gym wrappers.

Pre-allocating mujoco_py done!  That was fast, like one or two days.
"""

# from rllab.algos.trpo import TRPO
from sandbox.adam.gpar2.algos.multi_gpu_trpo import MultiGpuTRPO
