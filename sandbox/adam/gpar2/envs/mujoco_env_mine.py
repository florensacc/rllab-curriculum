...
# Just the point it to my own mujoco_py version:
...
MODEL_DIR = osp.abspath(
    osp.join(
        ...
        '/home/adam/GitRepos/rllab-private/vendor/mujoco_models'
...
class MujocoEnv(Env):
    ...
    def __init__(self, action_noise=0.0, file_path=None, template_args=None):
        ...
        # self.reset()  # moved this into humanoid, after allocate and all.
