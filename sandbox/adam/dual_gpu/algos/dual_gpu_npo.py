...
from sandbox.adam.dual_gpu.algos.multi_gpu_batch_polopt import DualGpuBatchPolopt
...
class DualGpuNPO(DualGpuBatchPolopt):
    """
    ...
    def __init__(
        ...
        super(DualGpuNPO, self).__init__(**kwargs)
    ...
    def init_opt(self, rank):
        ...
        # maybe self.baseline.initialize_rank(rank)
