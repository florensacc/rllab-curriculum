...
from rllab.core.network import ConvNetwork, TwoConvNetwork
...
class TwoGaussianConvPolicy(StochasticPolicy, LasagnePowered, Serializable):
    """
    ...
    def __init__(
        ...
        super(TwoGaussianConvPolicy, self).__init__(env_spec)
