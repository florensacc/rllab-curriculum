        ...
        for maze_size_scaling in [7, 9]:
            ...
            for time_step_agg in [100, 500, 800]:
                ...
                algo = TRPO_snn(
                    ...
                    batch_size=1e4 / time_step_agg,
                    whole_paths=True,
                    max_path_length=1e3 / time_step_agg * maze_size_scaling / 2.,  # correct for larger envs
                    n_itr=200,
                    discount=0.99,
                    step_size=0.01,
                )
                ...
                for s in [10]:  # range(10, 110, 10):  # [10, 20, 30, 40, 50]:
                    ...
                    exp_name = exp_prefix + '{}scale_{}agg_{}pl_PRE{}_{}'.format(maze_size_scaling,
                                                                                 time_step_agg, int(
                            5e3 / time_step_agg * maze_size_scaling / 2.),
                                                                                 pkl_path.split('/')[-2], s)
