                    ...
                    for goal_vector_obs in [True, False]:
                        for dying_cost in [0, -10]:
                            ...
                            for s in range(0, 30, 10):
                                ...
                                exp_name = exp_prefix + '_{}displStd_{}sensSpan_{}InvgoalDistRew_{}dieCost_{}goalVectObs_{}'.format(
                                                        ''.join(str(displ_std).split('.')), int(sensor_span),
                                                        ''.join(str(goal_dist_rew).split('.')), dying_cost,
                                                        str(goal_vector_obs), s)
