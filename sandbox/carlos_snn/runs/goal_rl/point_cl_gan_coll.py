...
if __name__ == '__main__':
    ...
    exp_prefix = 'goalGAN-point-coll'
    vg = VariantGenerator()
    vg.add('seed', range(10, 30, 10))
    # # GeneratorEnv params
    vg.add('goal_size', [4, 3, 2, 3])  # this is the ultimate goal we care about: getting the pendulum upright
    vg.add('reward_dist_threshold', [1, 0.5, 1])
