...
if __name__ == '__main__':
    ...
    def run_task(v):
        ...
        env = GoalIdxExplorationEnv(env=inner_env, goal_generator=fixed_goal_generator,
                                    ...
                                    reward_dist_threshold=v['reward_dist_threshold'], goal_reward=v['goal_reward'],
        ...
        for outer_iter in range(v['outer_iters']):
            ...
            if outer_iter > 0:
                ...
                old_goal_indices = np.random.randint(0, all_goals.shape[0], 200)
