...
if __name__ == '__main__':
    ...
    # # GeneratorEnv params
    vg.add('goal_range', [2])  # this will be used also as bound of the state_space
    vg.add('goal', [(1, 1)])  # this is the ultimate goal we care about: getting the pendulum upright
    ...
    def run_task(v):
        ...
        env = GoalIdxExplorationEnv(env=inner_env, goal_generator=fixed_goal_generator, # idx=np.arange(np.size(v['goal'])),
                                    reward_dist_threshold=0.3, goal_reward=v['goal_reward'],
