...
class Trainer(Serializable):
    ...
    def train(self, n_samps=200):
        expert_samples = self.collect_supervision_data(self.demo_collector, self.env_cls, self.horizon, n_samps)
    ...
    def collect_supervision_data(demo_collector, env_cls, horizon, n_samps):
        paths = []
