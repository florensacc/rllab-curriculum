...
class PointEnv(MujocoEnv, Serializable):
    ...
    def __init__(self, should_render=True, init_height=25, init_width=25, *args, **kwargs):
    ...
    def get_current_obs(self):
        ...
        image_trans = np.fromstring(data, dtype='uint8').reshape(height, width, 3)[::-1, :, :]
        #print(self.get_viewer().get_image().shape)
        return image_trans
