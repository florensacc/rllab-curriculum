...
class MixtureDemoCollector(Serializable):
    ...
    def collect_demo(self, env, horizon, novice):
        ...
        return mixture_rollout(env=env, expert_agent=policy, novice_agent=novice, max_path_length=horizon,
                               animated=False)
...
if __name__ == "__main__":
    ...
    p = MixtureDemoCollector(ConoptParticleTrackingPolicy, ConoptParticleTrackingPolicy)
