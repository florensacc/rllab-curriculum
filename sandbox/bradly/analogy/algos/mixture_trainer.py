...
class Trainer(Serializable):
    ...
    def get_new_mixed_data(self, demo_seeds, analogy_seeds, target_seeds):
        ...
        return train_dict, env, dataset, test_dict, subsampled_train_dict, data_dict, analogy_envs
    ...
    def train(self):
        ...
        train_dict, env, dataset, test_dict, subsampled_train_dict, data_dict, analogy_envs = self.get_new_mixed_data(demo_seeds, analogy_seeds, target_seeds)
