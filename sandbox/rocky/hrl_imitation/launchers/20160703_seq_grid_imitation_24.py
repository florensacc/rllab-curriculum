...
"""
Get rid of variational inference
Didn't seem to matter very much
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation11 import FixedClockImitation, SeqGridPolicyModule
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_24",
        seed=v["seed"],
        variant=v,
        mode="local",
        snapshot_mode="last",
