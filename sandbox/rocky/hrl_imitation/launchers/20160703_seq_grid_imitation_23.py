...
"""
Closer look into estimation of p(g|z), use sgd instead of lbfgs for updating the optimizer. Larger networks
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation10 import FixedClockImitation, SeqGridPolicyModule
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_23_large",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
