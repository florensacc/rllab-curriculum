...
"""
#38 with bug fix in batch weighted sampling
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation21 import FixedClockImitation, SeqGridPolicyModule
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_39",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
