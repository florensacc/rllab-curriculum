...
"""
Rerun #34 with more logs
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation20 import FixedClockImitation, SeqGridPolicyModule
...
vg.add("mi_coeff", [1.0])#0., 0.1, 1., 10.])
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_35",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
