...
"""
Investigate different optimization parameters
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation18 import FixedClockImitation, SeqGridPolicyModule
...
vg.add("log_prob_tensor_std", [0.01, 0.1, 1.0, 10.0])
vg.add("batch_size", [32, 500, 6000])
vg.add("dim_multiple", [1, 5, 20])
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_33",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
