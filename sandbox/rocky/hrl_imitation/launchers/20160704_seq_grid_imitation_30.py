...
"""
Direct log likelihood maximization + stochastic bottleneck layer + smaller learning rates + sgd on regressor
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation16 import FixedClockImitation, SeqGridPolicyModule
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_30",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
