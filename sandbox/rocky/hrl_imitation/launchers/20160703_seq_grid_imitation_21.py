...
"""
Batch optimization. Optimize I(a;g|z)
"""

from sandbox.rocky.hrl_imitation.algos.fixed_clock_imitation8 import FixedClockImitation, SeqGridPolicyModule
...
vg.add("mi_coeff", [0., 0.001, 0.01, 0.1, 1., 10., 100.])
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="seq_grid_imitation_21",
        seed=v["seed"],
        variant=v,
        mode="lab_kube",
        snapshot_mode="last",
