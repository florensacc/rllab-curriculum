...
class VG(VariantGenerator):
    ...
    @variant
    def env_cls(self):
        return [SwimmerEnv, HopperEnv, HalfCheetahEnv, Walker2DEnv, AntEnv]
...
for v in variants:
    ...
    es = EpsilonGreedyStrategy(env_spec=env.spec, epsilon_decay_range=1000000 * mult, max_epsilon=0., min_epsilon=0.)
    algo = DQN(
        env=env,
        qf=qf,
        target_qf=target_qf,
