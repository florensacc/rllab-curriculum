...
def run_task(vv):
    ...
    from sandbox.rocky.chainer.algos.rnn_bc_trainer import Trainer
    from sandbox.rocky.chainer.policies.gaussian_rnn_policy import GaussianRNNPolicy
    from sandbox.rocky.chainer.policies.rnn_utils import NetworkType
