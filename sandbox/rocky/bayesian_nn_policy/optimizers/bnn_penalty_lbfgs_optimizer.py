...
class BNNPenaltyLbfgsOptimizer(Serializable):
    """
    ...
    def optimize(self, policy, paths):
        ...
        def gen_f_opt(penalty):
            def f(flat_params):
                ...
                return self.aggregate_average(self._opt_fun["f_opt"], policy, paths, (penalty,))
            return f
        ...
        for penalty_itr in range(self._max_penalty_itr):
            ...
            _, try_loss, try_constraint_val = self.aggregate_average(self._opt_fun["f_penalized_loss"], policy,
                                                                     paths, (try_penalty,))
