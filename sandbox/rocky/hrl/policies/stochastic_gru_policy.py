...
class StochasticGRUPolicy(StochasticPolicy, LasagnePowered, Serializable):
    ...
    def __init__(self, env_spec, n_subgoals, hidden_sizes=(32, 32),
    ...
    def state_info_keys(self):
        return ["action_prob", "decision_prob", "hidden_prob", "hidden_state", "switch_goal", "prev_hidden"]

    @property
    def dist_info_keys(self):
        return ["action_prob", "decision_prob", "hidden_prob", "hidden_state", "switch_goal"]
    ...
    def dist_info_sym(self, obs_var, state_info_vars):
        ...
        return dict(
            ...
            decision_prob=decision_prob_var,
            hidden_state=hidden_var,
            switch_goal=switch_goal_var,
            # prev_hidden=prev_hidden_var,
        )
    ...
    def kl_sym(self, old_dist_info_vars, new_dist_info_vars):
        ...
        return hidden_kl + action_kl + decision_kl
    ...
    def likelihood_ratio_sym(self, action_var, old_dist_info_vars, new_dist_info_vars):
        ...
        return hidden_lr * action_lr * decision_lr
    ...
    def get_action(self, observation):
        ...
        return action, dict(
            ...
            decision_prob=np.asarray([decision_prob]),
            hidden_prob=hidden_prob,
            hidden_state=self.hidden_state,
            prev_hidden=prev_hidden,
            switch_goal=np.asarray([switch_goal]),
        )
