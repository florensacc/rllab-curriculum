...
from sandbox.rocky.hrl_new.launchers.exp20160718.algo1 import Algo, CategoricalLookbackPolicy
...
"""
Renormalize after computing the mixture of descent directions
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def mi_coeff(self):
        return [1.0, 0., 0.1, 0.5, 0.7, 0.9]#0., 0.01, 0.1, 1.]
