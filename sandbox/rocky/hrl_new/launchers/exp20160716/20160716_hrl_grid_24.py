...
from sandbox.rocky.hrl_new.policies.theano_categorical_hgru_policy import CategoricalHGRUPolicy
...
"""
Inspect GRU's behavior on simple grid, in Theano
"""
