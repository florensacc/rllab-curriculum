...
class BottleneckStateGoalSurpriseBonusEvaluator(object):
    ...
    def __init__(
        ...
        bottleneck_dim = env_spec.observation_space.components[0].flat_dim
    ...
    def predict(self, path):
        ...
        bottlenecks = obs[:, :self.bottleneck_dim]
        next_bottlenecks = next_obs[:, :self.bottleneck_dim]
        ...
        mi_est = log_p_zt_given_gt_zt1 - log_p_zt_given_zt1
        surprise_est = -log_p_st_given_gt_st1
    ...
    def fit_before_process_samples(self, paths):
        ...
        self.fit_delayed = lambda: self.state_given_prev_regressor.fit(obs, next_obs); \
