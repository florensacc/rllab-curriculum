...
from sandbox.rocky.hrl_new.launchers.exp20160720.algo3 import BonusTRPO, GoalBasedSurpriseBonusEvaluator, \
    FixedClockPolicy
...
"""
Goal-based with longer code. Do not use surprise
"""
