...
from sandbox.rocky.hrl_new.launchers.exp20160719.algo2 import BonusTRPO, GoalBasedSurpriseBonusEvaluator, \
    FixedClockPolicy
...
"""
Revisit goal-based formulation: I(g;s'|s) = H(g|s) - H(g|s,s')
"""
