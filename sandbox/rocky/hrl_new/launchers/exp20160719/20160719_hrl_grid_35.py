...
from sandbox.rocky.hrl_new.launchers.exp20160719.algo3 import BonusTRPO, StateGoalSurpriseBonusEvaluator, \
    FixedClockPolicy
...
class VG(VariantGenerator):
    ...
    @variant
    def env_mode(self):
        return ["easy", "medium"]#easy", "medium", "hard"]
