...
# game.set_doom_game_path(os.path.join(DOOM_PATH, "scenarios/test.wad"))
...
# game.set_doom_scenario_path(os.path.join(DOOM_PATH, "scenarios/basic.wad"))
# game.set_doom_scenario_path("/Users/dementrock/research/ruby-doom/test_wads/stepstep.wad")
game.set_doom_scenario_path(os.path.join(config.PROJECT_PATH, "wads/basic2.wad"))
# game.set_doom_scenario_path("/Users/dementrock/Downloads/cdirip/bin/DOOM/HOTELHEL.WAD")
...
game.set_screen_resolution(ScreenResolution.RES_160X120)#RES_)
...
print("initializing took", time.time() - start_time)
...
for i in range(N_actions):
    actions.append([False] * i + [True] + [False] * (N_actions - i - 1))
...
print("FPS: %f/s" % (counter / (end_time - start_time)))
# print(counter)
...
#
#
# from vizdoom import DoomGame, ScreenResolution, Button, GameVariable, ScreenFormat, Mode
# game = DoomGame()
#
# DOOM_PATH = os.environ["DOOM_PATH"]
#
...
# game.set_vizdoom_path(os.path.join(DOOM_PATH, "bin/vizdoom"))
# game.set_doom_game_path(os.path.join(DOOM_PATH, "scenarios/freedoom2.wad"))
# game.set_doom_game_path(os.path.join(DOOM_PATH, "scenarios/basic.wad"))
# game.set_doom_map("map01")
