...
class BonusNPO(NPO):
    def __init__(self, bonus_evaluator, bonus_coeff, *args, **kwargs):
        ...
        super(BonusNPO, self).__init__(*args, **kwargs)

    def log_diagnostics(self, paths):
        super(BonusNPO, self).log_diagnostics(paths)
...
class BonusTRPO(BonusNPO):
    ...
    def __init__(
        ...
        super(BonusTRPO, self).__init__(optimizer=optimizer, **kwargs)


class BonusPPO(BonusNPO):
    """
    ...
    def __init__(
        ...
        super(BonusPPO, self).__init__(optimizer=optimizer, **kwargs)
