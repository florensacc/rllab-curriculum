...
"""
Test different initial entropy
"""
...
class VG(VariantGenerator):
    ...
    def softmax_param(self):
        return ["exact_entropy"]#, "exact_entropy", "default", "normalized"]

    @variant
    def initial_entropy_percentage(self):
        return [0.99, 0.95, 0.9, 0.8]
