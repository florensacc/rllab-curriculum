...
"""
Test state-dependent exact entropy
"""
...
class VG(VariantGenerator):
    ...
    def softmax_param(self):
        return ["exact_entropy_dependent", "default"]#, "exact_entropy", "default", "normalized"]
...
for vv in variants:  # [:2]:
    ...
    def run_task(v):
        ...
        if v["softmax_param"] == "default":
            ...
            action_param = SoftmaxExactEntropy(dim=4, input_dependent=False)
