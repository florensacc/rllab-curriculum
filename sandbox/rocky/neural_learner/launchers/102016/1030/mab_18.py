...
"""
Test resetter - only reset from original trajectories, + recompute hidden states + optionally adapt learning rates
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def recompute_hidden_states(self):
        return [True, False]
    ...
    def run_task(v):
        ...
        if v["use_reset"]:
            ...
            env = TfEnv(MultiResetterEnv(
                ...
                recompute_hidden_states=v["recompute_hidden_states"],
            ))
        else:
            env = TfEnv(MultiEnv(
                wrapped_env=MABEnv(n_arms=v["n_arms"]),
        ...
        if v["use_ac"]:
            ...
            algo = PPOSGDAC(
                ...
                adaptive_learning_rate=v["adaptive_learning_rate"]
            )
        else:
