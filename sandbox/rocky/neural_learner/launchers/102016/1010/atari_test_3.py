...
"""
Benchmark on Atari (breakout and pong), comparing (1) feed-forward vs. recurrent policies (2) second-order TRPO vs.
first-order
with lr clipping
"""
