...
class VG(VariantGenerator):
    @variant
    def seed(self):
        return [10*x+1 for x in range(6, 26)]#[11, 21, 31, 41, 51]
    ...
    def run_task(v):
        ...
        env = TfEnv(
            MultiEnv(
                ...
                n_episodes=10,#v["n_episodes"],
                episode_horizon=100,#v["episode_horizon"],
                discount=v["discount"],
            )
        )
        ref_env = TfEnv(
        ...
        #         rescale_obs=v["rescale_obs"],
        #         difficulty=v["difficulty"],
        #         randomize_texture=v["randomize_texture"],
        #         n_repeats=v["n_repeats"],
        #         n_targets=v["n_targets"]
        #     )
        # )
