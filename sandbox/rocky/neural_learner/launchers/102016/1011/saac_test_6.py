...
"""
Benchmark on Atari, less entropy bonus
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def game(self):
        return ["breakout"]#, "pong"]  # "beam_rider", "pong", "breakout", "qbert"]
...
for vv in variants:
    ...
    def run_task(v):
        ...
        env = TfEnv(
            AtariEnv(game=v["game"], terminate_on_life_lost=True, reset_on_life_lost=False, obs_type="ram"))
        eval_env = TfEnv(
            AtariEnv(game=v["game"], terminate_on_life_lost=False, reset_on_life_lost=False, obs_type="ram"))
