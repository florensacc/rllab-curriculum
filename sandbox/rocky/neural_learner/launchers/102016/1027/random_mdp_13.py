...
class VG(VariantGenerator):
    ...
    def batch_size(self, n_episodes):
        if MODE == "local":
            return [10000]
        return [250000, 500000]#, 100000, 50000, 10000]  # 10000, 50000]
