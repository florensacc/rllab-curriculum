...
"""
Have primitive actions built in, more challenging version
"""
...
class VG(VariantGenerator):
    ...
    def batch_size(self):
        if MODE == "local":
            return [10000]
        return [10000, 50000]  # 20000, 100000]
    ...
    @variant
    def frame_skip(self, use_primitives):
        if use_primitives:
            return [1]
        return [4]
    ...
    def wall_penalty(self):
        return [0.001]  # , 0.001, 0.0001, 0.01]
        ...
        env = TfEnv(
            MultiEnv(
                wrapped_env=DoomFixedGoalFindingMazeEnv(
                    ...
                    version="v1",
                    map_preset=None,
                    use_primitives=v["use_primitives"],
