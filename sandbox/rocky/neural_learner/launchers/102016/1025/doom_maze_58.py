...
"""
Try po env on small size first, with landmarks + random orientations
Rerun with the print statement removed
"""
        ...
        env = TfEnv(
            MultiEnv(
                wrapped_env=DoomPoEnv(
                    ...
                    rand_start=v["rand_start"],
                    forced_visible_range=v["forced_visible_range"],
                    min_dist=v["min_dist"],
