...
"""
Bandits in Doom, test longer horizons
"""
...
for idx, vv in enumerate(variants):
    ...
    def run_task(v):
        ...
        from sandbox.rocky.neural_learner.envs.doom_bandits_env import DoomBanditEnv
        from sandbox.rocky.neural_learner.envs.doom_front_bandits_env import DoomFrontBanditEnv
        from sandbox.rocky.neural_learner.envs.doom_deterministic_bandits_env import DoomDeterministicBanditEnv
        env = TfEnv(
            MultiEnv(
                wrapped_env=DoomDeterministicBanditEnv(
