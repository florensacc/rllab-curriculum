...
"""
Try ac + wall penalty in general maze training, larger batch size.
"""
...
class VG(VariantGenerator):
    @variant
    def seed(self):
        return [10 * x + 1 for x in range(3)]
