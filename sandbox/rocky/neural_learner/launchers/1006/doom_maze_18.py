...
"""
Test exact entropy with different number of FC units
"""
...
for vv in variants:  # [:2]:
    ...
    def run_task(v):
        ...
        policy = CategoricalRNNPolicy(
            ...
            feature_network=new_feature_network("embedding_network", output_dim=v["num_units"]),
            name="policy"
        )
