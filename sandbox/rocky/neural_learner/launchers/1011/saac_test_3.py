...
"""
Benchmark on Atari. SAAC with better logging
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def game(self):
        return ["breakout"]#"beam_rider", "pong", "breakout", "qbert"]

    @variant
    def learning_rate(self):
        return [7e-4]#1e-2, 5e-3, 1e-3, 7e-4]
...
for vv in variants:
    ...
    def run_task(v):
        ...
        if v["algo"] == "saac":
            actor_critic = JointActorCritic(env_spec=env.spec, hidden_sizes=v["hidden_sizes"])
