...
"""
Run on GPU with reduced memory usage (hopefully)
"""
...
class VG(VariantGenerator):
    ...
    def n_particles(self):
        return [2, 4, 6]#6]  # 5]#3, 4, 5, 6]

    @variant
    def n_train_trajs(self):
        return [2000]#2000]#, 5000]#0]#5000]#, 20000]  # , 20000]#1000, 5000, 20000]

    @variant
    def hidden_dim(self):
        return [32]#100]#50, 100]
...
for v in variants:
    ...
    run_experiment_lite(
        algo.train(),
        exp_prefix="analogy-particle-17",
        mode="lab_kube",
        n_parallel=0,
        seed=v["seed"],
        variant=v,
