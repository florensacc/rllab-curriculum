...
"""
Try curriculum
We gradually increase the sequence length, while the number of particles is fixed.
"""
...
def run_task(v):
    ...
    def curriculum_criterion(paths, envs):
        return envs[0].success_rate(paths, envs) >= 0.8
