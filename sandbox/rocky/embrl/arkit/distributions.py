...
from .custom_ops import CustomPhase, resconv_v1_customconv, plstmconv_v1, int_shape, \
...
class GaussianLikeUniform(Gaussian):
    """
...
class Uniform(Distribution):
    def __init__(
        ...
        self._name = "%sD_Uniform_id_%s" % (dim, G_IDX)
        global G_IDX
        G_IDX += 1
