...
class VBNNLayer(lasagne.layers.Layer):
    ...
    def __init__(self,
        ...
        self.mu_old = self.add_param(
            np.zeros((self.num_inputs, self.num_units), dtype=floatX),
            (self.num_inputs, self.num_units),
            name='mu_old',
            trainable=False,
            oldparam=True
        ...
        self.rho_old = self.add_param(
            np.ones((self.num_inputs, self.num_units), dtype=floatX),
            (self.num_inputs, self.num_units),
            name='rho_old',
            trainable=False,
            oldparam=True
        ...
        self.b_mu_old = self.add_param(
            np.zeros((self.num_units,), dtype=floatX),
            (self.num_units,),
            name="b_mu_old",
            regularizable=False,
            trainable=False,
        ...
        self.b_rho_old = self.add_param(
            np.ones((self.num_units,), dtype=floatX),
            (self.num_units,),
            name="b_rho_old",
            regularizable=False,
            trainable=False,
