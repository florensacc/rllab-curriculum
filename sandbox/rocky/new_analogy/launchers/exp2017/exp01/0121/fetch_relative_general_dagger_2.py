...
def run_task(vv):
    ...
    gpr_env = fetch_utils.gpr_fetch_env(horizon=horizon, height=3)
...
for batch_size in [2048, 4096]:
    ...
    for hidden_sizes in [(256, 256), (512, 512)]:#(256, 256), (512, 512), (1024, 1024), (1024, 1024, 1024)]:
        run_cirrascale(
        # run_ec2(
        # run_local_docker(
            run_task,
            exp_name="fetch-relative-general-dagger-2",
            variant=dict(
