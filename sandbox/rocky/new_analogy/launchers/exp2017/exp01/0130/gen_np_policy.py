...
# resource_manager.register_file("fetch_5_blocks_dagger_v2.pkl", "/tmp/params.pkl")


file_name = resource_manager.get_file("fetch_5_blocks_dagger_v2.pkl")
...
with tf.Session() as sess:
    ...
    W0 = all_params["policy/policy/hidden_0/W:0"]
    b0 = all_params["policy/policy/hidden_0/b:0"]
    W1 = all_params["policy/policy/hidden_1/W:0"]
    b1 = all_params["policy/policy/hidden_1/b:0"]
    W2 = all_params["policy/policy/output/W:0"]
    b2 = all_params["policy/policy/output/b:0"]
