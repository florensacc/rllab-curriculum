...
"""
Try FF network, but linear feature baseline
"""
...
def run_task(vv):
    ...
    from sandbox.rocky.new_analogy.tf.algos.pposgd_clip_ratio import PPOSGD
    ...
    algo = PPOSGD(
        ...
        use_kl_penalty=vv["use_kl_penalty"],
