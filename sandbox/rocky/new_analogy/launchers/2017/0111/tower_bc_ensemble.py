...
def run_task(vv):
    ...
    from sandbox.rocky.new_analogy.algos.ensemble_ff_bc_trainer import Trainer
    ...
    with tf.Session() as sess:
        ...
        for idx in range(20):
            ...
            # with tf.variable_scope("policy_%d" % idx):

            policy_list.append(GaussianMLPPolicy(
                env_spec=env.spec,
        ...
        # policy = MedianEnsemblePolicy(policies)
