...
class VG(VariantGenerator):
    ...
    def disc_cost_form(self):
        return ["softplus"]  # "linear", "sum_square", "square", "softplus"]
...
def run_task(vv):
    ...
    from sandbox.rocky.new_analogy.discriminators.gcl_cost_learner import GCLCostLearner
    from sandbox.rocky.new_analogy.discriminators.gcl_cost_learner_fixing import GCLCostLearnerFixing
    import joblib
...
for v in variants:
    run_experiment_lite(
        ...
        exp_prefix="gcl-finetune-claw-2",
        mode=MODE,
        use_gpu=True,
        snapshot_mode="last",
