...
from sandbox.rocky.tf.core.rnn_cells import rnn_cell_modern
from sandbox.rocky.tf.core.rnn_cells import rnn_cell_layernorm_modern
from sandbox.rocky.tf.core.rnn_cells import rnn_cell_mulint_layernorm_modern
from sandbox.rocky.tf.policies.gaussian_tf_rnn_policy import DependentDiagonalGaussian, GlobalDiagonalGaussian
...
class VG(VariantGenerator):
    ...
    @variant
    def dist_head_cls(self):
        return [DependentDiagonalGaussian, GlobalDiagonalGaussian]
...
def run_task(vv):
    ...
    from sandbox.rocky.tf.policies.gaussian_tf_rnn_policy import DependentDiagonalGaussian
    ...
    policy = GaussianTfRNNPolicy(
        ...
        name="policy",
        dist_head_cls=vv["dist_head_cls"],
    )
