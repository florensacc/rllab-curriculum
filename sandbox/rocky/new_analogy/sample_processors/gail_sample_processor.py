...
class GAILSampleProcessor(DefaultSampleProcessor):
    ...
    def process_samples(self, itr, paths):
        ...
        logger.log("Fitted discriminator...")
        logger.log("Computing discriminator rewards...")
        for path, rewards in zip(paths, self.discriminator.batch_predict(paths)):
            path["raw_rewards"] = path["rewards"]
            path["rewards"] = rewards
        logger.log("Computed discriminator rewards...")
        ...
        logger.record_tabular('AverageDiscountedDiscReturn',
                              average_discounted_return)
        ...
        logger.record_tabular_misc_stat('DiscReturn', undiscounted_returns, placement='front')
        logger.record_tabular_misc_stat('Return', undiscounted_raw_returns, placement='front')
