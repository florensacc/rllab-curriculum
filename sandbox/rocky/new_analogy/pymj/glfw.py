...
# ===== ORIGINAL =====
# ===== REPLACEMENT FOR MUJOCO WRAPPERS =====
if sys.platform == 'win32':
    raise NotImplementedError('Windows is not supported')
else:
    from .cymj import ext_path
    root, ext = os.path.splitext(os.path.basename(ext_path))
    _glfw = _load_library([root], [ext], [os.path.dirname(ext_path)], _glfw_get_version)
# ===== REPLACEMENT FOR MUJOCO WRAPPERS =====
