cdef extern from "mjmodel.h" nogil:
    ...
    ctypedef enum mjtDisableBit:        # disable default feature bitflags
        ...
        mjDSBL_MOCAP                    # copy mocap data into fixed body xpos/quat
        mjDSBL_SENSOR                   # sensor simulation
        ...
        mjDSBL_BROADPHASE               # broad phase collision detection
    ...
    ctypedef enum mjtEnableBit:         # enable optional feature bitflags
        ...
        mjENBL_BOXCONVEX                # use convex collider for box-box
