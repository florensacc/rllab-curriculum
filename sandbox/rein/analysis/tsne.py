...
X1 = _X1[batch_size * start_itr:batch_size * end_itr, :2]
...
scatter1 = ax1.scatter(
    X1[:, 0], X1[:, 1], c=color, cmap=plt.cm.Spectral, lw=0, alpha=0.05)
scatter2 = ax2.scatter(
    X2[:, 0], X2[:, 1], c=color, cmap=plt.cm.Spectral, lw=0, alpha=0.05)
