...
for counter in range(100):
    ...
    #     Y2 = X2
        ...
        for simplex in hull1.simplices:
            plt.plot(Y1[simplex, 0], Y1[simplex, 1], '-',
                     lw=2, ls='dashed', color='blue')
        for simplex in hull2.simplices:
            plt.plot(Y2[simplex, 0], Y2[simplex, 1],
                     '-', lw=2, ls='dashed', color='red')
    ...
    if success:
        ...
        plt.show()
        plt.savefig(
            '/home/rein/Desktop/temp/fig' + str(counter) + '.png', bbox_inches='tight')
        plt.clf()
