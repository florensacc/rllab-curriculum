...
Try vddpg on Ant with distance from origin as reward. See if it moves
    consistently in many directions.
+ Use target_update_frequency = 1000
* reward_scale: 1, 10, 100 (since 1 and 0.1 look the same in exp-002)
"""
# imports -----------------------------------------------------
