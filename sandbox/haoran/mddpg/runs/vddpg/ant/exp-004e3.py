...
* tune the wall offset
* try different pretraining iterations
"""
# imports -----------------------------------------------------
...
for v in variants:
    ...
    if mode == "local_test" or mode == "local_docker_test":
        ...
        alg_kwargs = dict(
            ...
            n_eval_paths=10,
            min_pool_size=20000,
            replay_pool_size=v["replay_pool_size"],
        )
...
from sandbox.haoran.mddpg.envs.mujoco.ant_puddle_env import AntPuddleEnv, generate_u_shaped_maze
puddles = generate_u_shaped_maze(
