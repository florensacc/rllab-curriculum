...
+ reward = a / (b + dist_to_goal) + speed
* experiment with init_reward_slope and speed_coeff
+ Maze-like multi-modal problem
"""
# imports -----------------------------------------------------
...
for v in variants:
    ...
    env_kwargs = {
        ...
        "init_reward_slope": v["init_reward_slope"],
        "mujoco_env_args": {
