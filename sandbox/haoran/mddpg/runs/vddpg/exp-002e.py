...
Continue exp-002d, replacing cos and sin of joint angles by the raw angles.
This way the Q-values may not explode and hence stabilize training.
"""
# imports -----------------------------------------------------
