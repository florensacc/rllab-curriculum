...
Test VDDPG on the conservative hopper (no forward reward).
We hope to see diverse ways to stay alive. Continue exp-009b, with changes:
* q_target_type: max -> mean
* com path plotting: fix the bound issue
"""
# imports -----------------------------------------------------
