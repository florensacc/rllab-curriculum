...
* q_target_type ("max" in exp-009h, "mean" in exp-009h2)
* policy_learning_rate
* exploration noise
* alpha
- switch_type = "per_action"

Notice that exp-009g, g2 failed because the temperature was too large.

Change settings to speedup training
* network size: try 100 (Vitchyr's) and larger
