...
Dragged swimmer env.
Test whether finalize_ops slows down computation or changes results
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def x_drag_limit(self):
        return [0, 0.1, 1, 5, 10]

    @variant
    def use_finalize_ops(self):
        return [True]
...
for v in variants:
    ...
    shared_ddpg_kwargs = dict(
        ...
        batch_size=64,
        use_finalize_ops=v["use_finalize_ops"],
    )
    ...
    policy = FeedForwardMultiPolicy(
        ...
        env.action_space.flat_dim,
        K=K,
        shared_hidden_sizes=(32,),
        independent_hidden_sizes=(32,),
    )
