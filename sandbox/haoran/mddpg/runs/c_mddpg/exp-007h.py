...
Continue exp-007d. Try annealing the reward scaling.
"""
# imports -----------------------------------------------------
...
class VG(VariantGenerator):
    ...
    def scale_reward_annealer_kwargs(self):
        return [
            dict(init_value=0.01, final_value=1., stop_iter=99),
            dict(init_value=0.1, final_value=1., stop_iter=99),
            dict(init_value=0.01, final_value=0.1, stop_iter=99),
            dict(init_value=0.01, final_value=1., stop_iter=49),
            dict(init_value=0.1, final_value=1., stop_iter=49),
            dict(init_value=0.01, final_value=0.1, stop_iter=49),
        ]
