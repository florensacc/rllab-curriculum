...
Attempt to learn multiple modes on Swimmer.
Parameters copied from exp-002b.
"""
# imports -----------------------------------------------------
...
class VG(VariantGenerator):
    ...
    def scale_reward_annealer_kwargs(self):
        return [
            dict(init_value=0.1, final_value=0.1, stop_iter=999),
            dict(init_value=0.01, final_value=0.01, stop_iter=999),
            dict(init_value=1, final_value=1, stop_iter=999),
        ]
