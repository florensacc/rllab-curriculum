...
parser.add_argument('--postfix',type=str, default='',nargs='?', help='e.g. .pkl')
...
while True:
    # note: need to reset the client after each round of deletion; otherwise aws rejects access
