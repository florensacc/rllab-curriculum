# Run a very large number of iterations, see whether bs=1k can beat bs=10k with the same total batch size
...
for env_name,gae_lambda,batch_size,reuse_history,reg_coeff in itertools.product(env_names,gae_lambda_list,batch_size_list,reuse_history_list, reg_coeff_list):
