# repeat exp_028e (not all seeds were completed), continue exp-028j
# resample trajs to compute cur adv
# not history
...
for env_name in env_names:
    for reuse_history, batch_size in itertools.product(reuse_history_list, batch_size_list):
