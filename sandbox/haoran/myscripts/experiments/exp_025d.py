...
# re-run exp_025c, with (faster) reformulated code, and fixed retrace() algorithm
...
for env_name,reuse_history in itertools.product(env_names,reuse_history_list):
        ...
        reuse = "h{max_len}{g}{kl}_{reweigh_type}".format(
