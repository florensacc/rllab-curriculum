# repeat exp_028i,j,k on other tasks
...
# varying params
env_names = ["walker","halfcheetah"]
cur_adv_mode_list = ["resample","default"]
reuse_history_list =[
    dict(
        max_len=1,
...
for env_name in env_names:
    for cur_adv_mode, reuse_history, batch_size in itertools.product(cur_adv_mode_list,reuse_history_list, batch_size_list):
