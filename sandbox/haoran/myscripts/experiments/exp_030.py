...
for reweigh_type,prev_gae_lambda \
    in itertools.product(["none","retrace","is"],[1.0,0.9,0.8,0.7]):
...
for env_name,reuse_history,batch_size in itertools.product(env_names,reuse_history_list,batch_size_list):
