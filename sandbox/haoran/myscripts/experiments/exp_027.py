# test momentum_type = "v2", which simply averages the current and previous policy gradients
...
# varying params
env_names = ["hopper"]
momentum_list = [0.2, 0.4, 0.6, 0.8, 0.0]
...
for env_name, momentum in itertools.product(env_names,momentum_list):
        ...
        exp_name_prefix="alex_{time}_{env_name}_m{momentum_type}_{momentum}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            momentum_type=momentum_type,
            momentum=momentum,
