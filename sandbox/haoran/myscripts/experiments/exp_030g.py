# Repeat exp_030f, with step size proportional to batch size.
# Reference: bs=10k corresponds to kl=0.01
...
for env_name,gae_lambda,batch_size,reuse_history,reg_coeff,step_size in itertools.product(env_names,gae_lambda_list,batch_size_list,reuse_history_list, reg_coeff_list, step_size_list):
