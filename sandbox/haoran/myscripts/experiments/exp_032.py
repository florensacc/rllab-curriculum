# Here we combine reusing data for gradient and for kl
# Notice that sf = 1.0 here, but previously (exp-030) we used sf = 0.5.
...
for reweigh_type,prev_gae_lambda,reuse_for_kl \
    in itertools.product(["none"],[0.9,0.8,0.7],[True,False]):
