...
# Rule out the effects of policy std on performance. Focus on knowing whether NPG indeed performs better than PG.
# Also use high backtrack_ratio to ensure that solutions lie strictly meets the KL constraint.
...
env_names = ["hopper","walker","halfcheetah","ant","human"]
