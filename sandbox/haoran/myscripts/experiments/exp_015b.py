...
# run more iterations for those using smaller step sizes
...
env_names = ["walker","hopper","halfcheetah","dpend","car_parking","ant"]
...
for env_name in env_names:
    for batch_size,step_size,n_itr in \
        ...
        exp_name_prefix="alex_{time}_{env_name}_kl{step_size}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            step_size=step_size,
