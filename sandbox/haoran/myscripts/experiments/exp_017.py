...
for env_name in env_names:
        ...
        exp_name_prefix="alex_{time}_{env_name}_fore{foretrack_info}_back{backtrack_info}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            foretrack_info="%d_%.2f"%(max_foretracks,foretrack_ratio),
            backtrack_info="%d_%.2f"%(max_backtracks,backtrack_ratio),
