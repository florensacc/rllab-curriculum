# Reuse previous data, with various importance sampling methods.
# Use a smaller gae_lambda for prev adv computation.
...
reuse_history_list = []
for reweigh_type,prev_gae_lambda \
    in itertools.product(["none","retrace"],[1.0,0.9,0.8,0.7]):
