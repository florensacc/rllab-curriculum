# Study the joint effect of regularization of FIM, batch size, and CGI.
# environments: Ant
# We expect to see that with more regularization, large CGI solutions will get better, but also closer to small CGI solutions.
# Also the amount of regularization probably depends on the distribution of e-values of FIM.
...
for env_name,cg_iters,reg_coeff,batch_size in itertools.product(env_names,cg_iters_list,reg_coeff_list,batch_size_list):
        ...
        exp_name_prefix="alex_{time}_{env_name}_cgi{cg_iters}_reg{reg_coeff}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            cg_iters=cg_iters,
