# continue exp_028h, resample adv for both prev and cur
# also test resample for cur, no history, but double batch size
...
for env_name in env_names:
    for reuse_history, batch_size in zip(reuse_history_list, batch_size_list):
