# study the effect of regularizer on simpler problems with smaller batch sizes
# continue exp_029, with larger regularizers
...
batch_size_list = np.array([1,3,5,10]) * 1000
reg_coeff_list = [1,10,100]
...
for env_name,reg_coeff,batch_size in itertools.product(env_names,reg_coeff_list,batch_size_list):
        ...
        exp_name_prefix="alex_{time}_{env_name}_reg{reg_coeff}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            reg_coeff=reg_coeff,
