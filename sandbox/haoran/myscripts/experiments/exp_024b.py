# test new code for reusing history with off-policy GAE
# experiment on Hopper, Walker
# I am still repeating experiments on previous default settings, in case we found some bugs in the new code.
# Later should try shorter horizon to accelerate experiments.
...
gae_lambda_list = [1.0, 0.98, 0.96, 0.94]
...
for env_name,batch_size,reuse_history,gae_lambda in itertools.product(env_names,batch_size_list,reuse_history_list,gae_lambda_list):
