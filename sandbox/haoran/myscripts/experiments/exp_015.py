...
# should we change cg_iters as well?
...
batch_sizes = np.array([20,10,5,2]) * 1000
env_names = ["walker","hopper","halfcheetah","dpend","car_parking"]
...
for env_name in env_names:
    for batch_size,step_size in zip(batch_sizes,step_sizes):
