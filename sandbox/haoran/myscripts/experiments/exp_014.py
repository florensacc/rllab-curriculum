# vary both CGI and network sizes
# also try more challenging tasks like SimpleHumanoid
...
env_names = ["human","ant","walker","hopper","halfcheetah"]
cg_iters_list = [10,100,500]
hidden_sizes_list=[(32,32,32),(100,100),(300,300),(100,100,100),(300,300,300)]
...
for batch_size,env_name,cg_iters,hidden_sizes in \
    itertools.product(batch_sizes,env_names,cg_iters_list,hidden_sizes_list):
        ...
        exp_name_prefix="alex_{time}_{env_name}_cgi{cg_iters}{reuse}_{nn_spec}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            cg_iters=cg_iters,
