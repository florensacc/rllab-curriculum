# 20160621_144600
# branch: trpo-cg
# new way to initialize CG from the previous iteration
# git commit: 103153adae83636c8c3ccf0ec35a7b222d70a0b6
...
for batch_size,env_name,cg_iters in \
    itertools.product(batch_sizes,env_names,cg_iters_list):
        ...
        exp_name_prefix="alex_{time}_{env_name}_cgi{cg_iters}{reuse}_bs{batch_size}k".format(
            time=timestamp,
            env_name=env_name,
            cg_iters=cg_iters,
