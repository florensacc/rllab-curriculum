# 20160615_124100
# trpo-momentum
# study whether momentum helps when more CG iterations are used
...
for batch_size,env_name,cg_iters,momentum in \
    itertools.product(batch_sizes,env_names,cg_iters_list,momentums):
        if env_name == "swimmer":
            env = SwimmerEnv()
        ...
        exp_name_prefix="alex_{time}_{env_name}_cgi{cg_iters}_bs{batch_size}k_m{momentum_args}".format(
            time=timestamp,
            env_name=env_name,
            cg_iters=cg_iters,
