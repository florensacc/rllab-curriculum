# 20160616_224100
# this is a continuation of exp_008; changing the task to walker, halfcheetah,double pendulum
# study the effect of exact regularized Fisher inverse
...
env_names = ["walker","halfcheetah","dpend"]
cg_iters_list = [0]
