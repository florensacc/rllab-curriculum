...
from sandbox.haoran.hashing.bonus_trpo.path_replayers.prioritized_path_replayer import PrioritizedPathReplayer
...
for v in variants:
    ...
    path_replayer = PrioritizedPathReplayer(
        alpha=0,
        use_raw_return=True,
        n_replay=None,
        max_recorded_paths=v["max_recorded_paths"],
