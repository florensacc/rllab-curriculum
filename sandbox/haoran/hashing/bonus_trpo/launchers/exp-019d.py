...
Test HackyHashV5
- change number of requested cpu
- tune the grid_size
    - beware that the agent may get stuck on the stairs if the observations were these coarse grid coordinates
- tune the observable entries
    - we want to make sure that the agent performs better than 2500, otherwise there is little reason to try this hacky hash
"""
# imports -----------------------------------------------------
""" baseline """
