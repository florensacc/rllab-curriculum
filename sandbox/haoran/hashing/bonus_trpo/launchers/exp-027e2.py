...
Further tune on Frostbite and Venture. Repeat exp-027e with tiny dim_key to show the downside of under-generalization.
"""
# imports -----------------------------------------------------
""" baseline """
...
class VG(VariantGenerator):
    ...
    @variant
    def base_bonus_coeff(self):
        return [0.01]

    @variant
    def game(self):
        return ["frostbite","venture"]
...
for v in variants:
    ...
    # bonus
    bonus_coeff=v["base_bonus_coeff"] * (256. / v["dim_key"])
    bonus_form="1/sqrt(n)"
    count_target=v["count_target"]
