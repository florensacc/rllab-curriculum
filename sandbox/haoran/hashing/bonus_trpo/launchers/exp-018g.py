"""
Parallel-TRPO w/ RAM observations
- increased logging of bonus rewards
- composite bonus evaluator (no more prime modulus, use multiple SimHash)
"""
# imports -----------------------------------------------------
""" baseline """
...
""" bonus """
from sandbox.haoran.hashing.bonus_trpo.bonus_evaluators.ale_composite_bonus_evaluator import ALECompositeBonusEvaluator
...
for v in variants:
    ...
    bucket_sizes=[15485867] # None means default
    ...
    bonus_evaluators = [
        ...
        for i in range(v["n_duplicate"])
    ]
    bonus_evaluator = ALECompositeBonusEvaluator(
