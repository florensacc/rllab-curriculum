...
Test the effect of Bloom filters; continue exp-027f
+ faster key compression
- faster dict query?
+ no snapshot (it takes ~150MB for dim_key=256)
+ try larger or smaller dim_key (worst case will be ~1.5GB for 50M frames)
"""
# imports -----------------------------------------------------
""" baseline """
