"""
Continue exp-009b
Montezuma's Revenge, use exploration bonus, include multiple RAM frames
Also record paths for each iteration, so that we can visualize the effect of exploration.
"""
