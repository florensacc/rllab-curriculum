"""
Continue exp-017d
- replace hacky hash by ConvHash
"""
# imports -----------------------------------------------------
""" baseline """
...
from sandbox.haoran.hashing.bonus_trpo.bonus_evaluators.hash.conv_hash import ConvHash
...
for v in variants:
    ...
    # )
    _hash = ConvHash(
        item_shape=(1,img_width,img_height),
        bucket_sizes=bucket_sizes,
        second_hash=None,
        parallel=use_parallel,
        **conv_hash_net_args
