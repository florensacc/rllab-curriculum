"""
RAM observations, image counts.
Understand the effect of LSH bonus on images.
Repeat exp-011b with n_last_screens = 1 to avoid insufficient memory.
"""
...
class VG(VariantGenerator):
    ...
    @variant
    def game(self):
        return ["breakout","freeway","montezuma_revenge","venture"]
