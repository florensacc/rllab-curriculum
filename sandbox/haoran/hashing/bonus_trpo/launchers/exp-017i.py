"""
Continue exp-017d
- use HackyHashV4, which also counts the skeleton's location; this is almost taking all relevant visual information into account
"""
# imports -----------------------------------------------------
""" baseline """
...
from sandbox.haoran.hashing.bonus_trpo.bonus_evaluators.hash.ale_hacky_hash_v4 import ALEHackyHashV4
