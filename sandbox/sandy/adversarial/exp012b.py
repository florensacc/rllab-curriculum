...
obs_min = 0
obs_max = 1
N = 3  # Reduce the number of rollouts, since we just want to visualize not to extimate performance
if 'test' in mode:
    N = 1
...
class VG(VariantGenerator):
    @variant
    def exp_game_norm_fgsm_eps(self):
        # First eps for exp-game-norm combo to decrease performance below 50%
        chosen_norm_eps_fname = "/home/shhuang/src/rllab-private/data/s3/adv-rollouts/exp010/transfer_exp_to_run_20170206_144335_006879.p"
...
for v in variants:
    experiments, game, norm, fgsm_eps = v['exp_game_norm_fgsm_eps']
