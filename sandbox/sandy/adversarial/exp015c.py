...
# adversary setup -----------------------------------------------
adversary_algo = 'fgsm'
adversary_algo_param_names = ['norm', 'fgsm_eps', 'policy_adv', 'policy_rollout', 'k', 't']  # Levels of all_output_h5
...
obs_min = 0
obs_max = 1
N = 1  # TODO: Change back to 10 when not evaluating at specific time steps
if 'test' in mode:
    N = 1
num_ts = 100
...
class VG(VariantGenerator):
    ...
    @variant
    def experiment(self):
        return ['async-rl_exp039', 'async-rl_exp039b'] # Format: algo-name_exp-index
