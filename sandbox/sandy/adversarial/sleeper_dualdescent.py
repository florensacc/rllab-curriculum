...
BASE_DIR = "/home/shhuang/src/rllab-private/sandbox/sandy/adversarial/output_sleeper_dualdescent_Feb22"
...
def main():
    ...
    games = ['pong', 'chopper', 'seaquest', 'space']
    norms = ['l-inf']
    #fgsm_eps = [0.0005, 0.001, 0.002, 0.004]
    fgsm_eps = [0.004, 0.002, 0.001, 0.0005]
    ks = [1,2,3,4,5]
    seed = 1
    ...
    for game in games:
        for exp in experiments:
            for n in norms:
                for k in ks:
                    if game == "pong" and k == 1:
                        continue
                    for e in fgsm_eps:
                        if game == "pong" and k == 2 and e == 0.004:
                            continue
