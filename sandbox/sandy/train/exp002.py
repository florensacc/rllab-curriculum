...
ec2_instance = "c4.2xlarge"  # TODO: Change to c4.8xlarge when I'm allowed to
price_multiplier = 3
subnet = "us-west-2a"
...
class VG(VariantGenerator):
    ...
    def seed(self):
        ...
        return [0]  # TODO: Try more seeds when I'm allowed to run multiple spot instances
...
for v in variants:
    ...
    if mode == "local_test":
        ...
        batch_size = 25000  # TODO: Increase to 100000 when I can run on c4.8xlarge
