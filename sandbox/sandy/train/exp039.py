...
for v in variants:
    ...
    img_width = img_size
    img_height = img_size
    n_last_screens = 1  # NOTE: Usually this is 4, but we want to force
                        # LSTM policy to use cell state
    n_iter = 200
    ...
    if agent_type == "a3c":
	    ...
	    beta=entropy_bonus,
            ...
            n_input_channels=n_last_screens,
            img_size=img_size
        )
        algo = A3CALE(
