...
if __name__ == '__main__':
    ...
    # setup ec2
    subnets = [
        'us-east-2c', 'us-east-2a', 'us-east-2b', 'ap-northeast-2a', 'ap-northeast-2c', 'us-east-1b', 'us-east-1a',
        'us-east-1d', 'us-east-1e', 'us-east-1f', 'eu-west-1a', 'eu-west-1b', 'eu-west-1c', 'us-west-2c', 'us-west-2b',
        'us-west-2a'
    ]
    ec2_instance = args.type if args.type else 'c4.2xlarge' #'m4.10xlarge'
    # configure instan
    ...
    exp_prefix = 'goal-sagg-riac-maze0'
    ...
    vg.add('use_competence_ratio', [True, False])  # !!!!
