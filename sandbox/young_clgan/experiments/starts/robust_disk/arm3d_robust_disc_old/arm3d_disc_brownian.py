...
from sandbox.young_clgan.experiments.starts.robust_disk.arm3d_robust_disc_old.arm3d_disc_brownian_algo import run_task
...
if __name__ == '__main__':
    ...
    vg.add('ultimate_goal', [(0., 0.3, -0.4)]) #todo: this needs to change
    vg.add('goal_size', [3])
    ...
    exp_prefix = 'start-smartreplay-arm3d-disk-robust'
    # Launching
