...
def run_task(v):
    ...
    uniform_start_generator = FixedStateGenerator(state=v['ultimate_goal'])
    ...
    # seed_starts = generate_starts(env, starts=[v['ultimate_goal']], size = 1000, subsample=v['num_new_starts']) #subsample = 200
    # find_all_feasible_states(env, seed_starts, distance_threshold=0.1, brownian_variance=1, animate=False)
    seed_starts = [v['ultimate_goal']]
    ...
    for outer_iter in range(1, v['outer_iters']):
        ...
        starts = generate_starts(env, starts=seed_starts, subsample=v['num_new_starts'], size = 1000,
