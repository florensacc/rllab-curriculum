...
from sandbox.young_clgan.experiments.carlos_exps.goals.maze.maze_gan_algo_rebuttal import run_task
...
if __name__ == '__main__':
    ...
    # setup ec2
    subnets = [
        'us-east-2a', 'us-east-2b', 'us-east-2c', 'ap-southeast-2b', 'ap-southeast-2c', 'eu-west-1a', 'eu-west-1b',
        'us-west-2c', 'us-west-2a', 'us-west-2b', 'ap-southeast-2a'
    ]
    ...
    exp_prefix = 'goalGAN-maze-rebuttal3'
    ...
    vg.add('replay_noise', [0])  # TODO: try this on the best
    # old hyperparams
