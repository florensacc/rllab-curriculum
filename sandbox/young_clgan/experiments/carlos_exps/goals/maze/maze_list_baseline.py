...
from sandbox.young_clgan.experiments.carlos_exps.goals.maze.maze_list_baseline_algo import run_task
...
if __name__ == '__main__':
    ...
    exp_prefix = 'goal-maze-list-baseline'
    ...
    vg.add('num_goals', [200])
    vg.add('onpolicy_samples', [1e4])  # [1e4])
    vg.add('goal_noise', [0.3, 0.5])
