...
from sandbox.young_clgan.experiments.carlos_exps.goals.maze.maze_oracle_algo import run_task
...
if __name__ == '__main__':
    ...
    exp_prefix = 'goal-maze-oracle'

    vg = VariantGenerator()
    vg.add('horizon', [400])
    vg.add('goal_size', [2])  # this is the ultimate goal we care about: getting the pendulum upright
    vg.add('goal_range', [5])  # this will be used also as bound of the state_space
    vg.add('goal_center', [(2, 2)])  # this will be used also as bound of the state_space
    ...
    vg.add('inner_iters', [2, 5])
    vg.add('outer_iters', lambda inner_iters: [int(200/inner_iters)])
    ...
    vg.add('num_new_goals', lambda inner_iters: [int(inner_iters * 50 / 2)])
    vg.add('num_old_goals', lambda num_new_goals: [int(num_new_goals/2)])
