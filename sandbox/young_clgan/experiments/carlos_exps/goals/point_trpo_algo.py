...
from sandbox.young_clgan.envs.base import FixedGoalGenerator, UniformGoalGenerator, \
...
def run_task(v):
    ...
    #     configs=gan_configs,
    # )
    env = GoalIdxExplorationEnv(env=inner_env, goal_generator=uniform_goal_generator,
