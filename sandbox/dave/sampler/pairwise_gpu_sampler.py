...
from sandbox.dave.sampler.base import BaseGpuSampler
from sandbox.dave.sampler.prog_bar import ProgBarCounter
# import gtimer as gt
import psutil
...
from sandbox.dave.rllab.spaces.box import Box as BoxDave
from rllab.spaces.discrete import Discrete


def get_space_properties(space_obj):
    if isinstance(space_obj, (Box, BoxDave)):
