...
def test():
    ...
    from sandbox.tuomas.mddpg.envs.multi_reward_env import MultiRewardEnv
    ...
    qf_multi = MultiCritic(critics=(intrinsic_critic, extrinsic_critic))
