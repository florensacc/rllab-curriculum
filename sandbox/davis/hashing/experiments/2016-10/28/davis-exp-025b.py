...
""" bonus """
from sandbox.davis.hashing.bonus_evaluators.ale_hashing_bonus_evaluator import ALEHashingBonusEvaluator
from sandbox.davis.hashing.bonus_evaluators.hash.feature_sim_hash import FeatureSimHash
from sandbox.davis.hashing.feature_extractors.spatial_softmax_feature_extractor import SpatialSoftmaxFeatureExtractor
from sandbox.davis.hashing.bonus_evaluators.preprocessor.rollaxis_preprocessor import RollaxisPreprocessor
...
for v in variants:
    ...
    bonus_form = "1/sqrt(n)"
    count_target = v["count_target"]
    retrieve_sample_size = 500  # reduces memory requirement if the count targets are images
    ...
    env = AtariEnv(
        ...
        subsample_rgb_images=subsample_rgb_images,
    ...
    # bonus
    feature_extractor = SpatialSoftmaxFeatureExtractor(
        image_shape=(3, img_height, img_width),
    ...
    preprocessor = RollaxisPreprocessor()
