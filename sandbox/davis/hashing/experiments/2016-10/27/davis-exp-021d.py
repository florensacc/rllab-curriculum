...
from sandbox.davis.hashing.bonus_evaluators.hash.sim_hacky_hash import SimHackyHash
...
for v in variants:
    ...
    use_onehot_encoding = v["use_onehot_encoding"]
    ...
    _hash = SimHackyHash(
        ...
        game=game,
        ram_names=ram_names,
        use_onehot_encoding=use_onehot_encoding,
