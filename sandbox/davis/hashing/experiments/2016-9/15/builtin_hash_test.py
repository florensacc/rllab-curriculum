...
from sandbox.davis.hashing.bonus_evaluators.builtin_hash_bonus_evaluator import BuiltinHashBonusEvaluator
...
def experiment_variant_generator():
    ...
    vg.add("bonus_evaluator",
           lambda env, granularity: [BuiltinHashBonusEvaluator(env.spec, granularity=granularity)],
           hide=True)
    vg.add("baseline",
