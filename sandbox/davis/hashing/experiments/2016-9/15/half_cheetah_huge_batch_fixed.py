...
info = """Trying large batch size for half cheetah. Previous experiment had a preprocessing step in
hashing_bonus_evaluator.py that was for dealing with images and shouldn't be there."""
...
def experiment_variant_generator():
    ...
    vg.add("bonus_coeff", [0, 0.00001, 0.0001, 0.001, 0.01, 0.1])
    vg.add("dim_key", [32, 64, 128, 256])
    return vg
