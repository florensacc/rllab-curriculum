...
class StochasticPolicy(Policy):
    ...
    def reparameterizable(self):
        """
        Returns whether this stochastic policy can be reparameterized so that action is a deterministic function of
        policy parameters and independent noise variable. For extreme baselines.
        :return:
        """
        return False
