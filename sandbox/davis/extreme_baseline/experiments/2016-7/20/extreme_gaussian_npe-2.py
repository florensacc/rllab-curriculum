...
from rllab.baselines.extreme_gaussian_baseline import ExtremeGaussianBaseline
...
# Name
exp_prefix = "extreme-gaussian-npe-2"
...
for batch_size, seed, env_noise, lookahead, mpl, end_early in configurations:
    env = normalize(NoisyPointEnv(env_noise, end_early=end_early))
    ...
    baseline = ExtremeGaussianBaseline(
        env.spec,
        lookahead=lookahead,
        use_env_noise=True,
        max_path_length=mpl,
