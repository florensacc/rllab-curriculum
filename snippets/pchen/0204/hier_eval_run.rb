...
mdps << "mujoco_1_22.gather.ant_gather_mdp"
mdps << "mujoco_1_22.gather.swimmer_gather_mdp"
mdps << "mujoco_1_22.ant_maze_mdp"
mdps << "mujoco_1_22.swimmer_maze_mdp"
...
mdps.each do |mdp|
    hss.each do |hidden_sizes|
        seeds.each do |seed|
            algos.each do |algo|
                exp_name = "hier_eval_#{inc = inc + 1}_#{seed}_#{mdp}_#{algo[:_name]}"
                params = {
                    mdp: {
                        _name: mdp,
                    },
