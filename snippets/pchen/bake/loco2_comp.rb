...
load_map["mujoco_1_22.walker2d_mdp"] = "fixed_walter_cheetah_loco_eval_34_103_mujoco_1_22.walker2d_mdp_npg"
load_map["mujoco_1_22.half_cheetah_mdp"] = "fixed_walter_cheetah_loco_eval_52_28_mujoco_1_22.half_cheetah_mdp_npg"
    ...
    (load ? [true, false] : [true]).each do |train|
        mdps.each do |mdp|
            hss.each do |hidden_sizes|
                seeds.each do |seed|
                    algos.each do |algo|
                        exp_name = "again_take2_bake_loco_#{inc = inc + 1}_#{seed}_#{mdp}_#{algo[:_name]}"
                        params = {
                            mdp: {
                                _name: mdp,
                            },
                            ...
                            policy: {
                                ...
                                load_params: load ? load_map[mdp] : nil,
