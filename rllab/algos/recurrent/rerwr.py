...
from rllab.algos.recurrent.recurrent_batch_polopt import RecurrentBatchPolopt
...
class RERWR(RecurrentBatchPolopt):
    """
    Recurrent Episodic Reward Weighted Regression [1]_
    ...
    def __init__(
        ...
        super(RERWR, self).__init__(**kwargs)
    ...
    def init_opt(self, mdp, policy, baseline):
        ...
        lower_bound = - TT.sum(
            advantage_var * policy.get_log_prob_sym(input_var, action_var) *
    ...
    def optimize_policy(self, itr, policy, samples_data, opt_info):
        ...
        input_values = list(extract(
            samples_data,
            "observations", "advantages", "actions", "valids"
        ))
