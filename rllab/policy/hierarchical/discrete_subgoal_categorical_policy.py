...
class DiscreteSubgoalCategoricalPolicy(StochasticPolicy, LasagnePowered,
                                       Serializable):
    ...
    concatenated with the subgoal, and emits the actual action for the MDP.
    """
    ...
    def __init__(
        ...
        super(DiscreteSubgoalCategoricalPolicy, self).__init__(mdp)
