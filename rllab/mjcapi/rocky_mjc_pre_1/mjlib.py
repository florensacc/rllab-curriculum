...
if sys.platform.startswith("darwin"):
    libfile = osp.abspath(osp.join(
        ...
        "../../../vendor/mujoco/pre_1/osx/libmjc.dylib"))
    # wrapper_libfile = osp.abspath(osp.join(
    #     osp.dirname(__file__),
    #     "../../../vendor/mujoco/pre_1/osx/libmjc2_wrapper.dylib"))
...
# this is only enough for inspecting models
mjlib.mj_loadModel.argtypes = [c_char_p]
