...
if sys.platform.startswith("darwin"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),"../../../vendor/mujoco/1_20/osx/libmujoco.dylib"))
elif sys.platform.startswith("linux"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),"../../../vendor/mujoco/1_20/linux/libmujoco.so"))
elif sys.platform.startswith("win"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),"../../../vendor/mujoco/1_20/win/mujoco.lib"))
else:
...
mjlib.mj_license.argtypes = [String]
mjlib.mj_license.restype = c_int
