...
from curriculum.experiments.goals.goal_ant.ant_gan_algo import run_task
...
if __name__ == '__main__':
    ...
    vg.add('goal_noise_level', [0.3])
    vg.add('gan_outer_iters', [250])

    vg.add('seed', lambda add_on_policy: range(2000, 3000, 100) if not add_on_policy else range(2000, 2500, 100))
